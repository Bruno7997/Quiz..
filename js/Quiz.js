class Quiz {
  ...
  play(){
    ...
    if(allContestants !== undefined){
      //eu tirei isso pq tava dando erro ↓
      //debugger;
      var display_Answers = 230;
      fill("Blue");
      textSize(20);
      //mudei o valor do X pq tava fora do canvas ↓
      text("*OBSERVAÇÃO: O jogador que respondeu corretamente está destacado na cor verde!",50,230);
